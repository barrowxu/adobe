...
FMatrix::FMatrix(U32 _hasScale, SFIXED _scaleX, SFIXED _scaleY, U32 _hasRotate, SFIXED 
				 _rotateSkew0, SFIXED _rotateSkew1, SCOORD _translateX, SCOORD _translateY)
{
...
unsigned long FRect::MinBits(void)
{
	unsigned long maxCoord = FSWFStream::MaxNum(xmin, xmax, ymin, ymax);
