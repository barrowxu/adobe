...
bool FDTDefineSoundWAV::loadWavFile( FILE* fp, SSound* soundData, U8** wavData, int* wavDataSize )
{
	...
	while ( nextseek<filesize )
	{
		...
		case 0x20746D66: //Format Chunk
		{
			...
			formatTag = read16( fp );
			FLASHOUTPUT("  Format Tag %04lXh:  ",formatTag);
			switch ( formatTag )
			{
			default:
			case 0x0000: FLASHOUTPUT("WAVE_FORMAT_UNKNOWN"); break;
			case 0x0001: FLASHOUTPUT("WAVE_FORMAT_PCM\n"); break;
			case 0x0002: FLASHOUTPUT("WAVE_FORMAT_ADPCM\n"); break;
			case 0x0005: FLASHOUTPUT("WAVE_FORMAT_IBM_CVSD\n"); break;
			case 0x0006: FLASHOUTPUT("WAVE_FORMAT_ALAW\n"); break;
			case 0x0007: FLASHOUTPUT("WAVE_FORMAT_MULAW\n"); break;
			case 0x0010: FLASHOUTPUT("WAVE_FORMAT_OKI_ADPCM"); break;
			case 0x0011: FLASHOUTPUT("WAVE_FORMAT_DVI_ADPCM or WAVE_FORMAT_IMA_ADPCM\n"); break;
			case 0x0015: FLASHOUTPUT("WAVE_FORMAT_DIGISTD\n"); break;
			case 0x0016: FLASHOUTPUT("WAVE_FORMAT_DIGIFIX\n"); break;
			case 0x0020: FLASHOUTPUT("WAVE_FORMAT_YAMAHA_ADPCM\n"); break;
			case 0x0021: FLASHOUTPUT("WAVE_FORMAT_SONARC\n"); break;
			case 0x0022: FLASHOUTPUT("WAVE_FORMAT_DSPGROUP_TRUESPEECH\n"); break;
			case 0x0023: FLASHOUTPUT("WAVE_FORMAT_ECHOSC1\n"); break;
			case 0x0024: FLASHOUTPUT("WAVE_FORMAT_AUDIOFILE_AF18\n"); break;
			case 0x0101: FLASHOUTPUT("IBM_FORMAT_MULAW\n"); break;
			case 0x0102: FLASHOUTPUT("IBM_FORMAT_ALAW\n"); break;
			case 0x0103: FLASHOUTPUT("IBM_FORMAT_ADPCM\n"); break;
			case 0x0200: FLASHOUTPUT("WAVE_FORMAT_CREATIVE_ADPCM\n"); break;
			}
